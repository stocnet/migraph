...
# Don't forget we want to look at which actors are least constrained 
...
# Let's us the node_tie_census() function
...
```{r k-discrete-hint-1}
# Let's us the node_structural_equivalence() function and set 'k' to 2
