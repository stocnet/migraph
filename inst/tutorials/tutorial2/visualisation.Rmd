...
```{r migraphexample2, exercise=TRUE}

```
  
```{r migraphexample2-solution}
...
By default, `{migraph}` doesn't add legends automatically, 
...
`{migraph}` supports the `{ggplot2}` way of adding legends
