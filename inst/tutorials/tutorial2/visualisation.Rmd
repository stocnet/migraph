...
```{r migrapheg, exercise=TRUE}

```
  
```{r migrapheg-solution}
library(migraph)
...
```{r migraphexample2, echo=TRUE, message=FALSE, warning=FALSE, exercise = TRUE}
...
```{r patchwork, echo=TRUE, message=FALSE, warning=FALSE, exercise = TRUE}
...
```{r layoutseg, echo=TRUE, message=FALSE, warning=FALSE, exercise = TRUE}
...
```{r ggrapheg, echo=TRUE, message=FALSE, warning=FALSE, exercise = TRUE}
library(ggraph)
