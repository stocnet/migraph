...
question("Why are lattices considered highly clustered and how do they limit diffusion?",
         answer("Each node is only directly connected to its neighbours",
                message = learnr::random_praise(),
                correct = TRUE),
         answer("Nodes are locally connected",
                message = learnr::random_praise(),
                correct = TRUE),
         answer("The graph is highly ordered",
                message = learnr::random_praise(),
                correct = TRUE),
