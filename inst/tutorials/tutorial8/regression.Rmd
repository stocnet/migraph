...
```{r plotfriends, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r blau, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r crossref, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r ei, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r homophily-present, echo=FALSE}
...
but `{manynet}` chooses more descriptive function names,
such as `test_random()`.
...
```{r rando, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r perm, exercise=TRUE, exercise.setup = "friends-solution"}
...
```{r qapmax, exercise=TRUE, exercise.timelimit = 240}
...
and `{manynet}` includes also a plot method for these results to
facilitate the quick interpretation of these results.

```{r qapinterp, exercise=TRUE, exercise.setup = "qapmax-solution"}
