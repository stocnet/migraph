...
question("Select statements that are true",
  ...
  answer("Permutated networks retain the structure of the original network",
         message = learnr::random_praise(),
         correct = TRUE),
  answer("Random networks retain the distribution of attributes in the original network",
         message = learnr::random_praise(),
         correct = TRUE),
  answer("Permutated networks retain the position of nodes in the original network", 
         message = "Permutated networks randomly reassign any variables and change positions of nodes by swapping the rows and columns of an adjacency matrix"),
...
question("What can we say from these results?",
  answer("We can reject the null hypothesis that there is no homophily for gender in the comparison with random networks",
         message = "The red line is not in the grey shaded zone"),
  ...
  answer("We can reject the null hypothesis that there is no homophily for gender in both CUG and QAP tests", 
         message = "The red lines in both plots are not in the grey shaded zone"),
  answer("We cannot reject the null hypothesis that there is no homophily for gender in both CUG and QAP tests",
         correct = TRUE),
  allow_retry = TRUE
)
```
