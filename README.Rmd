...
- `r library(migraph); paste0(ls("package:migraph")[grepl("^as_", ls("package:migraph"))], "()")`
...
- `r library(migraph); paste0(ls("package:migraph")[grepl("^is_", ls("package:migraph"))], "()")`

`{migraph}`'s `to_*()` functions can be used on any class object 
to transform networks into networks with other properties, e.g.:

- `r library(migraph); paste0(ls("package:migraph")[grepl("^to_", ls("package:migraph"))], "()")`
...
- `r library(migraph); paste0(ls("package:migraph")[grepl("^create_", ls("package:migraph"))], "()")`

The `generate_*` group of functions generate networks from particular
generative mechanisms, e.g.:

- `r library(migraph); paste0(ls("package:migraph")[grepl("^generate_", ls("package:migraph"))], "()")`
...
- `r library(migraph); ls("package:migraph")[grepl("^mpn_", ls("package:migraph"))]`
- `r library(migraph); ls("package:migraph")[grepl("^ison_", ls("package:migraph"))]`
...
- `r library(migraph); paste0(ls("package:migraph")[grepl("^read_", ls("package:migraph"))], "()")`
- `r library(migraph); paste0(ls("package:migraph")[grepl("^write_", ls("package:migraph"))], "()")`
...
- Blockmodelling: `node_structural_equivalence()`, `node_regular_equivalence()`
