...
and thus tries to work well with whatever format you are already working with.
...
one class into another, losing as little information as possible along the way.
...
`{migraph}` includes algorithms for creating and generating
