...
`{migraph}` works with and extends existing network analysis packages for analysing multimodal and multilevel networks.
It provides a common, standard syntax for working with 
...
to transform networks into networks with other properties, e.g.:
