...
To make sure you have the vignettes installed, 
please either install the latest binary from CRAN for your OS,
or use the `remotes` command above to make sure that the vignettes are also built.

Once you have the package with the vignettes built installed,
you can access them using the following command:
`r browseVignettes("migraph")`.

This gives you access to the compiled vignettes in html form,
