...
- Connectedness: `graph_components()`, `graph_cohesion()`, `graph_adhesion()`, `graph_diameter()`, `graph_length()`
- Diversity: `graph_diversity()`, `graph_homophily()`, `graph_assortativity()`
- Structural holes: e.g. `node_redundancy()`, `node_effsize()`, `node_efficiency()`, `node_constraint()`, `node_hierarchy()`
- Topological features: e.g. `graph_core()`, `graph_factions()`, `graph_modularity()`, `graph_smallworld()`, `graph_balance()`

#### Motifs

- Censuses: `r list_functions("node_.*_census")`,  `r list_functions("graph_.*_census")`
