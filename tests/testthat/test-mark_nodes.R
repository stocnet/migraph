...
test_that("node isolate works", {
  ...
  expect_equal(length(node_is_isolate(ison_brandes)), graph_nodes(ison_brandes))
})

test_that("node_is_max works", {
  expect_equal(length(node_is_max(node_betweenness(ison_brandes))), graph_nodes(ison_brandes))
...
test_that("node_is_min works", {
  expect_equal(length(node_is_min(node_betweenness(ison_brandes))), graph_nodes(ison_brandes))
