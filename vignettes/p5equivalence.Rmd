...
![plot of chunk separatingnets](figure/separatingnets-1.png)
...
![plot of chunk constraintplot](figure/constraintplot-1.png)
...
![plot of chunk find-se](figure/find-se-1.png)
...
![plot of chunk vary-clust](figure/vary-clust-1.png)

```r
plot(node_structural_equivalence(ison_algebra, cluster = "hier", distance = "manhattan"))
```

![plot of chunk vary-clust](figure/vary-clust-2.png)

```r
plot(node_structural_equivalence(ison_algebra, cluster = "concor"))
```

![plot of chunk vary-clust](figure/vary-clust-3.png)
...
![plot of chunk k-discrete](figure/k-discrete-1.png)
...
![plot of chunk elbowsil](figure/elbowsil-1.png)

```r
plot(node_structural_equivalence(ison_algebra, k = "silhouette"))
```

![plot of chunk elbowsil](figure/elbowsil-2.png)
...
![plot of chunk strict](figure/strict-1.png)
...
![plot of chunk strplot](figure/strplot-1.png)
...
![plot of chunk block](figure/block-1.png)
...
![plot of chunk structblock](figure/structblock-1.png)
