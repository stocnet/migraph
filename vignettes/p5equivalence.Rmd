...
![plot of chunk separatingnets](teaching/separatingnets-1.png)
...
#>   Melinda  Abby Darryl Veronica Rylan Lindsey  Lula  Elva
#> 1   0.930 0.877  0.664    0.987 0.611   0.609 0.900 0.894
#> # ... with 8 more from this nodeset in the vector.
```
...
![plot of chunk constraintplot](teaching/constraintplot-1.png)
...
![plot of chunk find-se](teaching/find-se-1.png)
...
#> # A tibble: 16 × 96
#>    fromM…¹ fromA…² fromD…³ fromV…⁴ fromR…⁵ fromL…⁶ fromL…⁷
...
#> 15       0       0       1       0       0       0       0
#> 16       0       0       0       0       0       0       0
#> # … with 89 more variables: fromElva_friends <dbl>,
#> #   fromMiriam_friends <dbl>, fromGeorge_friends <dbl>,
#> #   fromLuella_friends <dbl>, fromDustin_friends <dbl>,
#> #   fromColleen_friends <dbl>, fromEzra_friends <dbl>,
#> #   fromMarsha_friends <dbl>, fromDiane_friends <dbl>,
#> #   toMelinda_friends <dbl>, toAbby_friends <dbl>,
#> #   toDarryl_friends <dbl>, toVeronica_friends <dbl>, …
...
![plot of chunk vary-clust](teaching/vary-clust-1.png)

```r
plot(node_structural_equivalence(ison_algebra, cluster = "hier", distance = "manhattan"))
```

![plot of chunk vary-clust](teaching/vary-clust-2.png)

```r
plot(node_structural_equivalence(ison_algebra, cluster = "concor"))
```

![plot of chunk vary-clust](teaching/vary-clust-3.png)
...
![plot of chunk k-discrete](teaching/k-discrete-1.png)
...
![plot of chunk elbowsil](teaching/elbowsil-1.png)

```r
plot(node_structural_equivalence(ison_algebra, k = "silhouette"))
```

![plot of chunk elbowsil](teaching/elbowsil-2.png)
...
![plot of chunk strict](teaching/strict-1.png)
...
![plot of chunk strplot](teaching/strplot-1.png)
...
summary(node_tie_census(ison_algebra),
        membership = str_clu)
#> # A tibble: 4 × 96
#>   fromMe…¹ fromA…² fromD…³ fromV…⁴ fromR…⁵ fromL…⁶ fromL…⁷
#>      <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>
#> 1        0   0.167   0.167       0   0.333     0.5     0  
#> 2        0   1       0.2         0   0.2       0.2     0.8
#> 3        0   0       0.75        0   1         1       0  
#> 4        0   0       0           0   0         0       0  
#> # … with 89 more variables: fromElva_friends <dbl>,
#> #   fromMiriam_friends <dbl>, fromGeorge_friends <dbl>,
...
![plot of chunk block](teaching/block-1.png)
...
![plot of chunk structblock](teaching/structblock-1.png)
