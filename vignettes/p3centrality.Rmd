...
#>   Phillip Giova…¹  Ezra Gordon Jameson  June Aaron Chester
#> 1       1       1     3      3       2     3     3       2
...
#>   Phillip Giova…¹  Ezra Gordon Jameson  June Aaron Chester
#> 1       0       0 0.378  0.485   0.133 0.337 0.304   0.122
#> # ... with 3 more from this nodeset in the vector.
node_closeness(ison_brandes)
#>   Phillip Giova…¹  Ezra Gordon Jameson  June Aaron Chester
#> 1   0.278   0.278 0.370  0.455   0.435 0.476 0.455   0.417
#> # ... with 3 more from this nodeset in the vector.
node_eigenvector(ison_brandes)
#>   Phillip Giova…¹  Ezra Gordon Jameson  June Aaron Chester
#> 1   0.106   0.106 0.277  0.510   0.437 0.615 0.631   0.464
#> # ... with 3 more from this nodeset in the vector.
