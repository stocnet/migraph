...
![](teaching/coercion-1.png)

```r
autographr(ison_brandes2)
```

![](teaching/coercion-2.png)
...
#>   Melinda Haley Mallory Pamela Florence  Cora  Olga
#> 1       1     1       3      3        2     3     3
#> # ... with 4 more from this nodeset in the vector.
```
...
#>   Melinda Haley Mallory Pamela Florence  Cora  Olga
#> 1       0     0   0.378  0.485    0.133 0.337 0.304
#> # ... with 4 more from this nodeset in the vector.
node_closeness(ison_brandes)
#>   Melinda Haley Mallory Pamela Florence  Cora  Olga
#> 1   0.278 0.278   0.370  0.455    0.435 0.476 0.455
#> # ... with 4 more from this nodeset in the vector.
