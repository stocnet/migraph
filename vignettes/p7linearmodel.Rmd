...
Let's say that we are interested in whether these researchers send more emails
to those who are cited more, or whether there is disciplinary homophily.

```{r qap-attr, eval=FALSE}
