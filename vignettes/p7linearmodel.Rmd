...
#>   <chr>                              <dbl>   <dbl>   <dbl>
#> 1 (intercept)                       1.72     0.194   0.95 
#> 2 alter Citations                  -0.0326  -0.588   0.605
#> 3 sim Citations                    24.4      2.86    0.225
#> 4 alter Discipline Mathematics/S… -16.8     -3.07    0.365
#> 5 alter Discipline Other          -10.6     -2.31    0.48 
#> 6 alter Discipline Sociology       -7.37    -1.90    0.515
#> 7 same Discipline                   3.90     1.23    0.41 
#> # … with abbreviated variable name ¹​statistic
glance(model1)
#> # A tibble: 1 × 8
#>   r.squared adj.r.sq…¹ sigma stati…² p.value    df df.re…³
#>       <dbl>      <dbl> <dbl>   <dbl>   <dbl> <dbl>   <int>
#> 1    0.0334     0.0275  43.1    5.67 8.33e-6     6     985
