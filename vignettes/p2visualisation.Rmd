...
```{r ggrapheg, echo=TRUE}
library(graphlayouts)
library(ggplot2)
library(ggraph)
bristol <- migraph::mpn_bristol
ggraph(bristol, layout = "fr") + 
  geom_edge_link(aes(width = weight*0.1), 
                 edge_colour = "black", 
                 edge_alpha = 0.25, 
                 arrow = arrow(angle = 45,
                               ...
                               type = "closed"),
                 end_cap = circle(1, "mm")) +
  geom_node_point(size = 0.5, shape = 19, colour = "blue") +
...
plot(g, vertex.size = igraph::degree(g)*5, # *5 to scale nodes
     vertex.shape = "circle", # choose from “none”, “circle”, “square”, “csquare”, “rectangle”, “crectangle”, “vrectangle”, “pie”, “raster”, or “sphere”
...
```{r migraphexample2, echo=TRUE}
library(migraph)
# autographr(ison_coleman,
#            labels = TRUE, 
#            node_color = RColorBrewer::brewer.pal(8, "Set3"),
#            node_shape = "circle",
#            node_size = "0.5",
#            edge_size = "0.2") + ggplot2::ggtitle("Visualisation")
```
