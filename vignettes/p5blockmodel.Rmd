...
```{r constraintplot}
autographr(m182_task, highlight_measure = "node_constraint",
...
```{r cluster-str}
(str_res <- node_structural_equivalence(ison_algebra))
```
...
```{r clustercensus, eval=FALSE}
summary(m182_task, reg_clu)
```
