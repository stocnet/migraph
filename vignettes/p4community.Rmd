...
data("ison_algebra_class", package = "migraph")
# ?migraph::ison_algebra_class
```
...
```{r addingnames}
ison_algebra_class <- to_named(ison_algebra_class)
...
```{r separatingnets}
(m182_friend <- to_uniplex(ison_algebra_class, "friend_tie"))
...
(m182_task <- to_uniplex(ison_algebra_class, "task_tie"))
