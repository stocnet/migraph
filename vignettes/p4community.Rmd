...
![plot of chunk addingnames](figure/addingnames-1.png)
...
![plot of chunk comp-memb](figure/comp-memb-1.png)
...
![plot of chunk manip-fri](figure/manip-fri-1.png)
...
![plot of chunk walkplot](figure/walkplot-1.png)
...
![plot of chunk walkplot](figure/walkplot-2.png)
...
![plot of chunk walkplot](figure/walkplot-3.png)
...
#> At core/community/
#> edge_betweenness.c:493 : Membership
#> vector will be selected based on the
#> highest modularity score.
#> Warning in
#> igraph::cluster_edge_betweenness(as_igraph(object)):
#> At core/community/
#> edge_betweenness.c:500 : Modularity
#> calculation with weighted edge
#> betweenness community detection
#> might not make sense -- modularity
#> treats edge weights as similarities
#> while edge betwenness treats them as
#> distances.
friend_eb
#> 1 
#>    1, 3, 4, 5, 8, 9, 10, 11, 14
...
![plot of chunk ebplot](figure/ebplot-1.png)
...
![plot of chunk fg](figure/fg-1.png)
...
#>  [1] EVELYN --E1 EVELYN --E2
#>  [3] EVELYN --E3 EVELYN --E4
#>  [5] EVELYN --E5 EVELYN --E6
#>  [7] EVELYN --E8 EVELYN --E9
#>  [9] LAURA  --E1 LAURA  --E2
#> [11] LAURA  --E3 LAURA  --E5
#> [13] LAURA  --E6 LAURA  --E7
#> [15] LAURA  --E8 THERESA--E2
#> + ... omitted several edges
autographr(ison_southern_women, node_color = "type")
```

![plot of chunk setup-women](figure/setup-women-1.png)

```r
autographr(ison_southern_women, "railway", node_color = "type")
```

![plot of chunk setup-women](figure/setup-women-2.png)
...
![plot of chunk easyway](figure/easyway-1.png)
...
![plot of chunk easyway](figure/easyway-2.png)
...
![plot of chunk otherway](figure/otherway-1.png)
